...
namespace Party_Tracker
{
    ...
    public sealed partial class AboutPage : Page
    {
        ...
        String versionString(Windows.ApplicationModel.PackageVersion version)
        {
        ...
        private async void button_contact_Click(object sender, RoutedEventArgs e)
        {
            ...
            var emailRecipient = new Windows.ApplicationModel.Email.EmailRecipient("maos@maoshouse.com");
